import {Client, Company} from "../server";

export const htmlPage = (client: Client, company: Company, date: string, amount: Number, currency: string, invoiceNumber: Number): string => {
    return  `
<meta charset="UTF-8">
<html>
    <head>
